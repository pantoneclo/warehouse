...
class ManageStock extends BaseModel implements JsonResourceful
{
    ...
    public function prepareAttributes(): array
    {
        return [
            ...
            'product_category_name' => $this->product->productAbstract->productCategory->name,
        ];
    }
    ...
    public function prepareWarehouseAttributes(): array
    {
        $fields = [
            'product_id' => $this->product_id,
            'quantity' => $this->quantity,
            'product_unit' => $this->product->productAbstract->product_unit,
            'product_unit_name' => $this->getProductUnitName(),
    ...
    {
        $productUnit = BaseUnit::whereId($this->product->productAbstract->product_unit)->first();
        if ($productUnit) {
