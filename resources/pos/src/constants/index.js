...
export const apiBaseURL = {
    ...
    EXPENSES: '/expenses',
    PRODUCTS: '/products',
    PRODUCTS_NO_PAGINATE: '/no-paginate/product-list',
    ...
    HOLDS_LIST: "holds",
    //NEW LIST ADDED BY MAHMUDUL HASSAN
    PACKAGES: "/packages",
    ...
    INVENTORY_DOWNLOAD: '/download-inventory',

    // New List Added by  Atiqur Rahman
...
export const constants = {
    ...
    UPDATE_TOTAL_RECORD_AFTER_ADD: 'UPDATE_TOTAL_RECORD_AFTER_CREATE',
...
export const Permissions = {
    ...
    PACKAGE_BARCODE_PRINT: 'package.barcode',
    ...
    SALE_RETURN_CREATE: 'return.create',
    SALE_RETURN_VIEW: 'return.view',
    ...
    ADJUSTMENT_EDIT: 'adjustment.edit',
    ...
    MANAGE_EXPENSES_CATEGORIES: 'manage.expense.categories',
    ...
    MANAGE_PRINT_BARCODE: 'manage.print.barcode',
    ...
    MANAGE_SMS_API: "manage.sms.apis",
    MANAGE_SMS_TEMPLATES: "manage.sms.templates",
    MANAGE_LANGUAGES: "manage.language",
    MANAGE_INVENTORY: "manage.inventory",
    // Atik
    MANAGE_COMBO: 'manage.products',


    // Added by Atiqur RAhman

    COMBO_EDIT: 'combo.edit',
...
export const packageActionType = {
    ...
    ADD_WAREHOUSE_TO_PACKAGES: 'ADD_WAREHOUSE_TO_PACKAGE',
...
export const productAbstractActionType = {
    FETCH_ABSTRACT_PRODUCTS: 'FETCH_ABSTRACT_PRODUCTS',
    FETCH_ABSTRACT_PRODUCT: 'FETCH_ABSTRACT_PRODUCT',
    ADD_ABSTRACT_PRODUCT: 'ADD_ABSTRACT_PRODUCT',
    EDIT_ABSTRACT_PRODUCT: 'EDIT_ABSTRACT_PRODUCT',
    DELETE_ABSTRACT_PRODUCT: 'DELETE_ABSTRACT_PRODUCT',
    FETCH_ALL_ABSTRACT_PRODUCTS: 'FETCH_ALL_ABSTRACT_PRODUCTS'
}
export const variantActionType = {
...
export const productAbstractAttributes = [
...
export const getLabelById = (id) => {
    const shippingCompany = shippingCompanyNames.find(company => company.id === id);
    return shippingCompany ? shippingCompany.label : '';
};
