...
import ProductAbstract from "./components/productAbstract/ProductAbstract";
import CreateProductAbstract from "./components/productAbstract/CreateProductAbstract";
import EditProductAbstract from "./components/productAbstract/EditProductAbstract";
import ProductAbstractDetail from "./components/productAbstract/ProductAbstractDetail";
import Variants from "./components/variant/Variants";
import CreatePackageBarcode from "./components/package/CreatePackageBarcode";
import VariantDetails from "./components/variant/VariantDetails";
...
export const route = [
    ...
    {
        path: "product/abstracts/create",
        ele: <CreateProductAbstract />,
        permission: Permissions.PRODUCT_CREATE,
    },
    {
        path: "product/abstracts/edit/:id",
        ele: <EditProductAbstract />,
        permission: Permissions.PRODUCT_EDIT,
    },
    {
        path: "product/abstracts/detail/:id",
        ele: <ProductAbstractDetail />,
    ...
    },
    {
        ...
        ele: <EditPackage />,
        permission: Permissions.PACKAGE_EDIT,
    },
    {
    ...
    },
    {
        ...
        permission: Permissions.ADJUSTMENT_CREATE
    },
    {
        path: "adjustments/:id",
        ele: <EditAdjustMent />,
        permission: Permissions.ADJUSTMENT_EDIT
    },
    {
        path: "settings",
        ele: <Settings />,
    ...
    },
    {
        ...
        ele: <EditPurchase />,
        permission: Permissions.PURCHASE_EDIT
    },
    {
    ...
    },
    {
        ...
        permission: Permissions.SALE_RETURN_EDIT
    },
    {
        path: "quotations",
        ele: <Quotations />,
    ...
    },
    {
        ...
        permission: Permissions.SALE_RETURN_VIEW
    },
    {
    ...
    {
        path: "report/report-sale-return",
    ...
    },
    {
        ...
        ele: <ComboCreate />,
        permission: Permissions.MANAGE_COMBO,
    },
    {
