...
const PurchaseReturn = (props) => {
    ...
    const view_permission = usePermission(Permissions.PURCHASE_RETURN_VIEW);
    const edit_permission = usePermission(Permissions.PURCHASE_RETURN_EDIT);
    const delete_permission = usePermission(Permissions.PURCHASE_RETURN_DELETE);
    const create_permission = usePermission(Permissions.PURCHASE_RETURN_CREATE);
    ...
    return (
        <MasterLayout>
            ...
            <ReactDataTable columns={columns} items={itemsValue} onChange={onChange} isLoading={isLoading}
                            ButtonValue={create_permission?getFormattedMessage('purchase.return.create.title'):null}
