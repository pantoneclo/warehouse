...
const PurchaseReturnForm = (props) => {
    const { addPurchaseReturnData, id, editPurchaseReturn, customProducts, singlePurchase, warehouses, suppliers,
        fetchProductsByWarehouse, products, frontSetting, allConfigData,  advanceSearch,
    } = props;
            ...
            <div className='card-body'>
                {/*<Form>*/}
                    <div className='row'>
                        ...
                        <div className='col-md-4 mb-5'  style={{zIndex:'500'}}>
                        ...
                        <div className='col-md-12 mb-5'>
                            ...
                            <AdvanceSearch   fetchAdvancedSearch={fetchAdvancedSearch} values={purchaseValue} products={advanceSearch} isAllProducts={true}
...
const mapStateToProps = (state) => {
    const {purchaseProducts, advanceSearch, frontSetting, allConfigData} = state;
    return {customProducts: preparePurchaseProductArray(advanceSearch), purchaseProducts, advanceSearch, frontSetting, allConfigData, fetchAllProducts}
};

export default connect(mapStateToProps, {editPurchaseReturn, fetchProductsByWarehouse, searchPurchaseProduct, fetchAllProducts,fetchAdvancedSearch})(PurchaseReturnForm);
