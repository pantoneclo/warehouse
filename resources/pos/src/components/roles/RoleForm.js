...
const RoleForm = (props) => {
    ...
    console.log(groupedPermissions, 'this is grouped permissions');
                        ...
                        <div>
                            <Form.Group className='mb-5 form-group'>
                               ...
                               <div className='d-flex col-md-12 flex-wrap'>
                                    {Object.entries(groupedPermissions).map(([prefix, permissions]) => (
                                        <div key={prefix} className="col-md-3 ">
                                            <h4>{prefix.toString().toUpperCase()}</h4> {/* Display the prefix as a section title */}
                                            <hr className='bg-danger fs-3'/>
