                ...
                {/*<Form>*/}
                    <div className='row'>
                        ...
                        <div className='mb-5'>
                            ...
                            <AdvanceSearch values={saleValue}  products={advanceSearch} handleValidation={handleValidation}
...
export default connect(mapStateToProps, {editSale, editQuotation, fetchProductsByWarehouse,fetchAdvancedSearch, fetchFrontSetting})(QuotationForm)
