...
const Brands = () => {
    const { brands, totalRecord, isLoading, isCallBrandApi } = useSelector(
        (state) => state
    );
    ...
    const view_permission = usePermission(Permissions.BRAND_VIEW);
    const edit_permission = usePermission(Permissions.BRAND_EDIT);
    const delete_permission = usePermission(Permissions.BRAND_DELETE);
    const create_permission = usePermission(Permissions.BRAND_CREATE);
    ...
    return (
        <MasterLayout>
            ...
            <ReactDataTable
                ...
                items={itemsValue}
                onChange={onChange}
                AddButton={create_permission ? <CreateBrands /> : null}
