...
const EditSaleReturnReportModal = (props) => {
    ...
    useEffect(() => {
        if (saleReportItem) {
            setSaleReportValue({
                ...
                sale_id: saleReportItem.sale_id || "", // ID of associated Sale
    ...
    const handleSubmit = (event) => {
        ...
        // Dispatches the edit action, passing redirect path '/app/report/report-sale-return' to stay on the page
        dispatch(editSaleReport(saleReportValue.sale_id, saleReportValue, navigate, '/app/report/report-sale-return'));
...
export default EditSaleReturnReportModal;
