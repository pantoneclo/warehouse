...
const ProductDetail = props => {
    ...
    // console.log(product?.attributes?.variants);
                        ...
                        <Spinner /> : <>
                            ...
                            <div className='col-xxl-7'>
                                <table className='table table-responsive gy-7'>
                                    ...
                                    <tr>
                                        <th className='py-4' scope='row'>Style</th>
                                    ...
                                    <tr>
                                        <th className='py-4' scope='row'>Variant</th>
                                        <td className='py-4'>{product && product.attributes && product.attributes.variant && <div>
                                        <span className='badge bg-light-warning'><span>{product.attributes.variant?.size}</span></span>
                                        <span className='badge bg-light-warning' style={{marginLeft:'10px'}}><span>{product.attributes.variant?.color}</span></span> </div>}</td>
                                    </tr>
                                    <tr>
                    ...
                    <tbody>
                       {variants && variants.map((item, index) => {
                        return(
                            <tr key={index}>
                                <td className='py-4'>{item.name}</td>
                                <td className='py-4'>{item.variant_cost}</td>
                                <td className='py-4'>{item.variant_price}</td>
                                <td className='py-4'>{item.code}</td>
                                <td className='py-4'> <Image  src={item.barcode_url} />  </td>
                                {/* <td className='py-4'>
                                    <div>
