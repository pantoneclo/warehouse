...
const PrintBarcode = (props) => {
    ...
    const { warehouses, products, advanceSearch, purchaseProducts, frontSetting, 
        allConfigData, customProducts = preparePurchaseProductArray(advanceSearch, true) } = useSelector(state => state)
    ...
    const [variantName, setVariant] = useState(true)
    ...
    const loadPrintBlock = () => {
        return (
            <div className='d-none'>
                ...
                <PrintButton ref={componentRef} frontSetting={frontSetting}
    ...
    return (
        <MasterLayout>
            ...
            <div className='card card-body'>
                {/* <Col md={4} className='ml-auto mb-3 col-12' style={{ zIndex: '100', position: 'relative' }}>
                    ...
                    <Table responsive>
                        <thead>
                            <tr>
                                ...
                                <th>{getFormattedMessage('stock')}</th>
                ...
                <Row>
                    ...
                    <div className="d-flex align-items-center mt-2">
                        <label className="form-check form-switch form-switch-sm">
                            <input type='checkbox' checked={variantName}
                                   name='Currency_icon_Right_side'
