        ...
        <div className='card'>
            <div className='card-body'>
                ...
                <div className='row'>
                    ...
                    <div className='col-md-4 mb-3' style={{zIndex : 500}}>
                    ...
                    <div className='col-md-12 mb-3'>
                        ...
                        <AdvanceSearch  fetchAdvancedSearch={fetchAdvancedSearch} values={transferValue} products={advanceSearch} isAllProducts={false}
...
const mapStateToProps = (state) => {
    const {products, frontSetting, allConfigData,advanceSearch} = state;
    return {customProducts: prepareTransferArray(advanceSearch), products,advanceSearch, frontSetting, allConfigData}
};

export default connect(mapStateToProps, {editTransfer,fetchProductsByWarehouse, fetchAllProducts,fetchAdvancedSearch})(TransferForm);
