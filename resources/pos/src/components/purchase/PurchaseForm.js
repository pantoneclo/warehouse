...
const PurchaseForm = (props) => {
    ...
    console.log(updateProducts, 'updateProducts from purchase form');
                    ...
                    <div className='row'>
                        ...
                        <div className='col-12 md-12'>
                            ...
                            <Table responsive>
                                ...
                                {updateProducts && updateProducts.map((singleProduct, index) => {
                                    return <PurchaseTable key={index} singleProduct={singleProduct} index={index}
                        ...
                        <div className='col-md-12 mb-5'>
                            ...
                            <textarea name='notes' className='form-control'
                                          ...
                                          value={purchaseValue.notes ? purchaseValue.notes : ''}
                            />
...
const mapStateToProps = (state) => {
    console.log (state,'products from purchase form');
...
export default connect(mapStateToProps, {editPurchase, fetchAllProducts, searchPurchaseProduct,fetchAdvancedSearch})(PurchaseForm);
