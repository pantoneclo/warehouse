export const editPrepareArray = (products, warehouse_id) => {
    ...
    products.forEach(product => {
        purchaseProductRowArray.push({
            ...
            pan_style: product.product.product_abstract.pan_style,
            ...
            tax_type: product.tax_type ? product.tax_type : 1,
            tax_value: product.tax_value,
            tax_amount: product.tax_amount,
            discount_type: product.discount_type,
            discount_value: product.discount_value,
            discount_amount: product.discount_amount,
            purchase_unit:product.purchase_unit.id && product.purchase_unit.id,
